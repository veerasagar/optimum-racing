...
|-----|--------------------------------|-------------------|------|----------------------------------------------|
| 1   | Explainable Reinforcement Learning for Formula One Race Strategy | Thomas, Devin, et al. | 2025 | This paper introduces RSRL (Race Strategy Reinforcement Learning), a reinforcement learning model designed to optimize race strategies in Formula One simulations. |
| 2   | AI-enabled prediction of sim racing performance using telemetry data | Fazilat Hojaji, Adam J. Toth, John M. Joyce, Mark J. Campbell | 2024 | The paper explores the application of data science and machine learning (ML) techniques to analyze and predict performance in sim racing, a rapidly growing segment of esports. |
| 3   | Deep Neural Network-based lap time forecasting of Formula 1 Racing | Zhao, Zhixuan | 2024 | This paper proposes a Deep Neural Network (DNN) model for predicting the fastest lap time in Formula 1 qualifying sessions. |
| 4   | Time series forecasting model for non-stationary series pattern extraction using deep learning and GARCH modeling | Han, Huimin & Liu, Zehua & Barrios, Mauricio & Li, Jiuhao & Zeng, Zhixiong & Sarhan, Nadia & Awwad, Emad | 2024 | This paper proposes a novel time series forecasting model that combines signal decomposition and deep learning techniques to address the challenges of non-linear and non-stationary time series data. |
| 5   | Deep-Racing: An Embedded Deep Neural Network (EDNN) Model to Predict the Winning Strategy in Formula One Racing | Fatima, Syeda Sitara Wishal, and Jennifer Johrendt | 2023 | The paper introduces Deep-Racing, an EDNN model designed to predict driver rankings and optimal pitstop strategies in Formula One racing. |
| 6   | Mastering Nordschleife - A comprehensive race simulation for AI strategy decision-making in motorsports | Boettinger, Max, and David Klotz | 2023 | This paper presents a novel reinforcement learning (RL)-based approach to optimize race strategy decisions in GT motorsports, specifically for the Nürburgring Nordschleife circuit. |
| 7   | An Analysis of Time Series Analysis and Forecasting Techniques | Malik, Pankaj & Dangi, Aditya & Singh, Aditya & Asst, Thakur & Pratap, Aditya & Parihar, Singh & Sharma, Utkarsh & Mishra, Lakshya | 2023 | This research paper provides a comprehensive analysis of time series analysis and forecasting techniques, examining their efficacy, applicability, and interpretability. |
| 8   | Bayesian analysis of Formula One race results: disentangling driver skill and constructor advantage | van Kesteren, Erik-Jan, and Tom Bergkamp | 2023 | This research paper investigates the relative contributions of driver skill and constructor advantage to success in Formula One racing. |
| 9   | Evolutionary F1 Race Strategy | Andrea Bonomi, Evelyn Turri, and Giovanni Iacca | 2023 | This paper proposes a custom Genetic Algorithm (GA) to optimize Formula 1 race strategies. |
| 10  | On the Optimization of Pit Stop Strategies via Dynamic Programming | Heine, O.F.C., Thraves, C. | 2023 | This paper presents two dynamic programming models for optimizing pit stop strategies in Formula 1 races: a deterministic model and a stochastic model. |
| 11  | Competitors-Aware Stochastic Lap Strategy Optimisation for Race Hybrid Vehicles | L. Paparusso, M. Riani, F. Ruggeri and F. Braghin | 2023 | This paper proposes a novel framework for optimizing lap strategies for hybrid race vehicles in the World Endurance Championship (WEC), considering the presence of competitors. |
| 12  | Application of Monte Carlo Methods to Consider Probabilistic Effects in a Race Simulation for Circuit Motorsport | Heilmeier, A.; Graf, M.; Betz, J.; Lienkamp, M. | 2020 | This paper presents a novel approach to modeling probabilistic effects in a race simulation for circuit motorsport, specifically focusing on Formula 1. |
| 13  | Virtual Strategy Engineer: Using Artificial Neural Networks for Making Race Strategy Decisions in Circuit Motorsport | Heilmeier, A.; Thomaser, A.; Graf, M.; Betz, J. | 2020 | This paper presents a methodology for automating race strategy decisions in circuit motorsport, specifically focusing on Formula 1. |
| 14  | Rank position forecasting in car racing | Peng, Bo, et al. | 2021 | This paper addresses the challenging problem of rank position forecasting in car racing, a domain characterized by high dynamics, uncertainty, and sparse data. |
| 15  | Time Series Analysis and Modeling to Forecast: a Survey | Dama, Fatoumata, and Christine Sinoquet | 2021 | This survey provides a comprehensive overview of time series modeling and forecasting techniques, focusing on parametric models for predictive purposes. |
| 16  | Online Planning for F1 Race Strategy Identification | Piccinotti, D. I. E. G. O., et al. | 2021 | This paper investigates the use of online planning algorithms for identifying optimal race strategies in Formula 1 (F1). |
| 17  | A Race Simulation for Strategy Decisions in Circuit Motorsports | Alexander Heilmeier, Michael Graf, and Markus Lienkarnp | 2018 | This paper presents a race simulation tool designed to support strategy decisions in circuit motorsports, particularly in Formula 1. |
| 18  | Planning Formula One race strategies using discrete-event simulation | Bekker, James & Lotz, W. | 2009 | This paper presents a discrete-event simulation model designed to assist Formula One racing teams in planning and evaluating their race strategies. |
| 19  | Optimizing Pit Stop Strategies with Competition in a Zero-Sum Feedback Stackelberg Game in Formula 1 | Aguad, Felipe & Thraves, Charles | 2023 | This paper presents a game theory model for optimizing pit stop strategies in Formula 1 races, considering competition between two drivers. |
| 20  | Competitors-Aware Stochastic Lap Strategy Optimisation for Race Hybrid Vehicles | L. Paparusso, M. Riani, F. Ruggeri and F. Braghin | 2023 | This paper proposes a novel framework for optimizing lap strategies for hybrid race vehicles in the World Endurance Championship (WEC), considering the presence of competitors. |
...
- **cite:** Aguad, Felipe & Thraves, Charles. (2023). Optimizing Pit Stops Strategies with Competition in a Zero-Sum Feedback Stackelberg Game. SSRN Electronic Journal. 10.2139/ssrn.4470115.
- **Year:** 2023
...
## Title: Competitors-Aware Stochastic Lap Strategy Optimisation for Race Hybrid Vehicles

- **cite:** L. Paparusso, M. Riani, F. Ruggeri and F. Braghin, "Competitors-Aware Stochastic Lap Strategy Optimisation for Race Hybrid Vehicles," in IEEE Transactions on Vehicular Technology, vol. 72, no. 3, pp. 3074-3089, March 2023, doi: 10.1109/TVT.2022.3215171
- **Year:** 2023
- **Summary:** This paper proposes a novel framework for optimizing lap strategies for hybrid race vehicles in the World Endurance Championship (WEC), considering the presence of competitors. The framework aims to minimize lap time while respecting energy usage constraints set by the technical regulations.
- **Key Points:**
  - Statistical Modeling of Competitors' Behavior: The authors analyze past WEC events to extract statistics on sector times and overtaking probabilities, which are then used to generate realistic Monte Carlo simulations of competitors' behavior.
  - Computation of Traffic-Free Optimal Strategies: A longitudinal vehicle model is developed and used to solve an optimization problem for lap time minimization in the absence of traffic. Genetic Algorithms are employed to generate a set of candidate optimal strategies with varying constraints on electric motor usage.
  - Optimal Strategy in Presence of Traffic: Stochastic Dynamic Programming (SDP) is implemented to evaluate the best strategy considering competitors' motion generated by the Monte Carlo simulator. The SDP approach accounts for the uncertainty associated with overtaking
- **Conclusion:** The framework provides a computationally efficient and statistically robust method for optimizing lap strategies for hybrid race vehicles in real-world racing conditions. The approach can be extended to other types of racing events and has the potential to significantly impact race outcomes.
- **Results:** The proposed approach is validated on data from a real race stint, demonstrating a significant reduction in lap time compared to the original strategy. The method is shown to be effective in shifting overtaking maneuvers to positions where they cause lower time losses.
